...
const slides = [
  {
    ...
    text: "Beyond simple web APIs, one of the most powerful tool categories is filesystem access. By exposing tools like read file and write file, an LLM can analyze your local codebase, review logs, and even rewrite entire documents."
  }
];
