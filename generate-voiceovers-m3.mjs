...
const slides = [
  {
    id: "m3-title",
    text: "A raw AI is like a brain trapped in a jar. It can think and talk, but it can't touch the outside world. To take action—to search the web, read files, or control software—it needs a Toolbelt."
  }
];
