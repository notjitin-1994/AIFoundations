...
export function ContextEngineeringSlide() {
  ...
  useEffect(() => {
    ...
    // Narration: "This brings us to Context Engineering. The three golden rules: keep the context clean, put the most important instructions at the very end, and use external memory when dealing with large datasets."
  ...
  const cards = [
    ...
    },
    {
      ...
      title: "2. Strategic Ordering",
      description: "Exploit the U-shaped curve. Place your system prompts at the very top, and your specific instructions/questions at the very bottom.",
      delay: 5.5,
    },
    {
      icon: HardDrive,
      title: "3. External Memory",
      description: "When dealing with large datasets, rely on RAG. Store the data in a database and let the AI search for what it needs.",
      delay: 8.0,
    }
  ];

  // Emil Kowalski's custom ease curve
  ...
  return (
    <div className="w-full h-full flex flex-col overflow-hidden p-6 md:p-8 max-w-6xl mx-auto relative group">
      ...
      <div className="shrink-0 mb-10 z-10 text-center">
          ...
          {cards.map((card, idx) => (
            <motion.div
              ...
              transition={{ 
                duration: 1.2, 
                ease: customEase, 
                delay: card.delay // Synced to audio timing roughly
              }}
