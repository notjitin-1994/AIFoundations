...
const slides = [
  {
    ...
    text: "Drag the slider to scan through the document's context buffer. Notice how the AI's attention score is perfect at the top and bottom, but plummets in the middle, causing critical details to be completely ignored."
  }
];
