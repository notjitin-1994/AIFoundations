...
const slides = [
  {
    ...
    text: "When an orchestration layer gives a language model three specific things, it transforms from a text generator into an autonomous agent. Those three pillars are: Autonomy to make decisions, Tools to take actions, and Memory to maintain context. Explore each pillar."
  },
  {
    id: "m4-5-tool-wiring",
    text: "A brain without hands cannot affect the world. Based on your Capstone selection, your Agent requires specific tools to be enabled in your harness. Toggle the required tools to wire them into your project."
  }
];
