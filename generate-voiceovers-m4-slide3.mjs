...
const slides = [
  {
    id: "m4-3-memory-injection",
    text: "Your harness is online. Now, we must give your Engine its brain. We do this by injecting a System Prompt into Persistent Memory. This document, often called AGENTS dot M D, dictates the rules, the tone, and the exact constraints for your Capstone project. Click inject to commit these rules to memory."
  }
];
