...
const slides = [
  {
    ...
    text: "Welcome to The Engine Room. In Module 2, you selected your Engine. In Module 3, you designed your Toolbelt. Now, we are turning the system on. Over this module, you are going to go on a guided learning spree alongside your AI. Your goal? To completely build out your capstone project using the environment you just configured."
  }
];
