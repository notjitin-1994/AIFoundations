...
const slides = [
  {
    id: "m4-2-initial-boot",
    text: "Every successful deployment starts with a handshake. Go ahead and initialize your harness. Once it mounts your tools and memory cache, send a diagnostic ping to the engine. We need to verify that it's online and listening before we give it autonomy."
  }
];
