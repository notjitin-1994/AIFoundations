...
const slides = [
  {
    ...
    text: "The AI itself doesn't browse the internet or run code. It strictly analyzes your prompt and generates a structured request—usually in JSON. This architectural separation is critical for system safety and control."
  },
  {
    id: "m3-function-calling-loop",
    text: "Here is the full execution loop. The LLM signals intent, a separate execution harness runs the actual function, and the result is fed back into the LLM to generate your final answer."
  }
];
