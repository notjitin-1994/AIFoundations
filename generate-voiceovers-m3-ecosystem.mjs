...
const slides = [
  {
    id: "m3-tool-registry",
    text: "Because MCP is an open standard, a massive community registry of servers has emerged. You don't have to build integrations from scratch. Instead, you can simply pull pre-built servers directly into your AI workflow."
  },
  {
    id: "m3-mcp-ecosystem",
    text: "This means your AI can instantly search the web, pull code from GitHub, query a local PostgreSQL database, or send messages in Slack—all using the exact same standard protocol."
  }
];
