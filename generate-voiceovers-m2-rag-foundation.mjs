...
const slides = [
  {
    ...
    text: "But RAG isn't just a trick for chatting with PDFs. It is the architectural foundation of modern AI. Every time an MCP fetches live data, or an agent loads a specific skill, they are using RAG principles to dynamically manage their context window. This is the essence of Context Engineering."
  }
];
